<div class="wrap">
	...
	<div class="wbcom-wrap">
		...
		<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Support', 'bp-activity-bump' ); ?></h4>
		<div id="wbcom_admin_content_support" class="wbcom_admin_tab_content">
			<strong><?php esc_html_e( 'Having any question or issue ?', 'bp-activity-bump' ); ?></strong>
			<p>
				<?php esc_html_e( 'Our team is here to help you out at anytime. If you have any idea about how we could improve. You can share access to your site on our helpdesk if it can help getting faster. There are two ways to in touch with us :', 'bp-activity-bump' ); ?></p>
				...
				<li class="wbcom_single_box wp-clearfix">
					...
					<div class="wbcom_single_right">
						<div class="wbcom_single_inner">
							<h4><?php esc_html_e( 'Tickets Support', 'bp-activity-bump' ); ?></h4>
							<p><?php esc_html_e( 'Open a ticket on our helpdesk, we don\'t guarantee a fast response but within a week. Except if you\'ve purchased one of our product we\'ll reply within 24 hours.', 'bp-activity-bump' ); ?></p>
							<div class="text-right">
								<a href="https://support.wbcomdesigns.com/portal/newticket" class="wb_btn wb_btn_default" target="_blank">
									<i class="fa fa-ticket"></i>
									<?php esc_html_e( 'Open a ticket', 'bp-activity-bump' ); ?>
								</a>
							</div>
						</div>
					</div>
